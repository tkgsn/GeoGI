...
parser.add_argument("--n_chosen", default=100, type=int)
...
if __name__ == "__main__":
    ...
    epsilons = [0.1, 0.3, 0.5, 0.7, 0.9, 1.1, 1.3, 1.5, 1.7, 1.9, 2.1, 2.3, 2.5, 2.7, 2.9, 3.1]
    ...
    for epsilon in epsilons:
        ...
        df.to_csv(f"results/{location_name}_epsilon{epsilon}_nchosen{n_chosen}_delta{delta}.csv", index=False)